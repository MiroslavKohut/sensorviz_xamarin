...
public class AccelerometerView
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("sensorviz_xamarin.AccelerometerView, sensorviz_xamarin, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AccelerometerView.class, __md_methods);
	}


	public AccelerometerView (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == AccelerometerView.class)
			mono.android.TypeManager.Activate ("sensorviz_xamarin.AccelerometerView, sensorviz_xamarin, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public AccelerometerView (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == AccelerometerView.class)
			mono.android.TypeManager.Activate ("sensorviz_xamarin.AccelerometerView, sensorviz_xamarin, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public AccelerometerView (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == AccelerometerView.class)
